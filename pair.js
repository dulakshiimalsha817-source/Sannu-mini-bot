...
const config = {
    ...
    IMAGE_PATH: 'https://i.ibb.co/RTkrBH1t/tourl-1762569900001.jpg',
    NEWSLETTER_JID: '120363405600029703@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: 'Quuen Imalsha mini',
    OWNER_NAME: 'withe Sannu x ',
    OWNER_NUMBER: '94772563976',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> ᴅᴇᴠᴏʟᴏᴘᴀʀ ʙʏ ꜱᴀɴɴᴜ x ʏᴀᴋᴜᴢᴀ.',
...
async function updateAboutStatus(socket) {
    const aboutStatus = 'qυєєη ιмαℓѕнα мιηι вσт ιѕ α¢тινє ησω🌸🧚‍♀️';
    try {
...
//================================ ALIVE ==================================
     ...
     const content = `𝐈𝐦 𝐐𝐮𝐞𝐞𝐧 𝐈𝐦𝐚𝐥𝐬𝐡𝐚 𝐦𝐢𝐧𝐢 𝐁𝐎𝐓 𝐌𝐚𝐝𝐞 𝐁𝐲 𝐂𝐲𝐛𝐞𝐫 𝐝𝐞𝐯𝐬.\n\n` +
                    `🧬 \`𝚟𝚎𝚛𝚜𝚒𝚘𝚗:\` ${config.BOT_VERSION}\n` +
                    `📡 \`𝙷𝚘𝚜𝚝:\` Heroku\n` +
                    `⏰ \`𝚁𝚞𝚗𝚝𝚒𝚖𝚎:\` ${hours}h ${minutes}m ${seconds}s\n` +
                    `👨‍💻 \`𝙾𝚠𝚗𝚎𝚛:\` ${config.OWNER_NAME}\n\n` +
                    `🌐 qυєєη ιмαℓѕнα мιηι вσт is a lightweight yet powerful WhatsApp user bot ⚡ built to handle downloads, searches, utilities, and fun commands — all in one place. Designed for speed 🚀, stability 🛡️, and style 🎭, it’s your personal уαкυzα assistant on WhatsApp.\n` +
                    `⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌\n` +
                    `𝑩𝑶𝑻 𝑾𝑬𝑩: තව නැතෝ\n` +
                    `▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n` +
                    `𝑪𝑯𝑨𝑵𝑬𝑳: තව නැ\n` +
...
//============================== OWNER ===============================
            ...
            + 'FN:SHALA OWNER\n'
            + 'ORG:SHALA OWNER\n'
            + 'TEL;type=CELL;type=VOICE;waid=94772563976 : 94772563976\n'
            + 'EMAIL:dinubinu23@gmail.com\n'
            + 'END:VCARD';

        await socket.sendMessage(sender, {
                            contacts: {
                                displayName: "Quuen imalsha mini Bot Ofc. Owner",
                                contacts: [{ vcard }]
                            }
                        });     
                break;     
...
//================================ SYSTEM ==================================                   
  ...
  const title = '*sannu xmd System Info*';
  const content = `┏━━━━━━━━━━━━━━━━\n` +
    `┃🤖 \`ʙᴏᴛ ɴᴀᴍᴇ\` : ${config.BOT_NAME}\n` +
    `┃🔖 \`ᴠᴇʀsɪᴏɴ\` : ${config.BOT_VERSION}\n` +
    `┃📡 \`ᴘʟᴀᴛꜰᴏʀᴍ\` : Heroku\n` +
